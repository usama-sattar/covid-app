        ...
        {(value) => {
          return (
            <View style={styles.container}>
              ...
              {value.countryCases.map((item,index) => (
                <View style={{ alignItems: "center" }}>
                  ...
                  <TouchableOpacity style={{backgroundColor:'maroon',width:80,height:45}}
                    onPress={()=>value.setFavourite(item)}
                  >
                      <Text style={{color:'white', textAlign:'center'}}>Add Favourite</Text>
                  </TouchableOpacity>
